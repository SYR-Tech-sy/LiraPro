...
const CURRENCY_NAMES: Record<string, string> = {
  ...
  // الدول الأفريقية والمغرب العربي
  TND: 'الدينار التونسي', MAD: 'الدرهم المغربي', DZD: 'الدينار الجزائري',
  LYD: 'الدينار الليبي', SDG: 'الجنيه السوداني', NGN: 'النايرا النيجيرية',
  ZAR: 'الراند الجنوب أفريقي',
  // آسيا وأوقيانوسيا
  JPY: 'الين الياباني', KRW: 'الوون الكوري الجنوبي', INR: 'الروبية الهندية',
  PKR: 'الروبية الباكستانية', BDT: 'التاكا البنغلاديشية', IDR: 'الروبية الإندونيسية',
  MYR: 'الرينغيت الماليزي', THB: 'البات التايلاندي', SGD: 'الدولار السنغافوري',
  HKD: 'الدولار الهونج كونجي', TWD: 'الدولار التايواني',
  // أمريكا وأوقيانوسيا
  CAD: 'الدولار الكندي', AUD: 'الدولار الأسترالي', NZD: 'الدولار النيوزيلندي',
  BRL: 'الريال البرازيلي', MXN: 'البيسو المكسيكي', ARS: 'البيسو الأرجنتيني',
  // أوروبا
  CHF: 'الفرنك السويسري', NOK: 'الكرون النرويجي', SEK: 'الكرون السويدي',
  DKK: 'الكرون الدنماركي', PLN: 'الزلوتي البولندي', CZK: 'الكرونة التشيكية',
  HUF: 'الفورينت الهنغاري', RON: 'الليو الروماني', UAH: 'الهريفنيا الأوكرانية',
  // دول الكومنولث وآسيا الوسطى
  GEL: 'اللاري الجورجي', AZN: 'المانات الأذربيجاني', AMD: 'الدرام الأرميني',
  KZT: 'التنغة الكازاخستانية', UZS: 'السوم الأوزبكستاني',
};
...
const FLAG_MAP: Record<string, string> = {
  ...
  NGN: '🇳🇬', ZAR: '🇿🇦',
  JPY: '🇯🇵', KRW: '🇰🇷', INR: '🇮🇳', PKR: '🇵🇰', BDT: '🇧🇩',
  IDR: '🇮🇩', MYR: '🇲🇾', THB: '🇹🇭', SGD: '🇸🇬', HKD: '🇭🇰', TWD: '🇹🇼',
  CAD: '🇨🇦', AUD: '🇦🇺', NZD: '🇳🇿', BRL: '🇧🇷', MXN: '🇲🇽', ARS: '🇦🇷',
  CHF: '🇨🇭', NOK: '🇳🇴', SEK: '🇸🇪', DKK: '🇩🇰', PLN: '🇵🇱',
  CZK: '🇨🇿', HUF: '🇭🇺', RON: '🇷🇴', UAH: '🇺🇦',
  GEL: '🇬🇪', AZN: '🇦🇿', AMD: '🇦🇲', KZT: '🇰🇿', UZS: '🇺🇿',
};
